...
export const Header = () => {
  return (
    <header className="bg-[url(./assets/image/headerbg2.webp)] bg-cover bg-center w-full min-h-[730px] sm:min-h-[890px] 2xl:min-h-[70vh] relative overflow-hidden -top-[100px]">
