...
import AboutLayor from "../assets/image/AboutLayer.webp";
import TokenomicsCartoon from "../assets/image/TokenomicsCartoon.webp";
import BabyDino from "../assets/image/CartoonCircle.webp";
  ...
  return (
    <div>
            ...
            <div className="relative xl:max-w-[589.84px] md:max-w-[430px] sm:max-w-[300px] max-w-[270px]">
              ...
              >
                <div className="flex flex-col gap-[5px]">
                  <p className="text-[#FBA11D] leading-[119%] lg:text-[32px] text-[23px] font-normal font-balsamiq">
                    333,333,333
                  </p>
                  <p className="text-white leading-[138%] font-normal text-[24px] text-right font-balsamiq">
                    Supply{" "}
                  </p>
                </div>
              ...
              >
                ...
                <div className="flex flex-col gap-[5px]">
                  <p className="text-[#8EC627] lg:max-w-[217px] max-w-[164px] leading-[119%] lg:text-[32px] text-[23px] font-normal font-balsamiq">
                    {" "}
              ...
              >
                ...
                <div className="flex flex-col gap-[5px]">
                  <p className="text-[#D45B07] max-w-[217px] leading-[119%] text-[32px] font-normal font-balsamiq">
                    {" "}
                    No Tax{" "}
                  </p>
                </div>
      ...
      data-aos="fade-down"
              ...
              >
                <div className="flex flex-col gap-[5px]">
                  <p className="text-[#23AAAC] max-w-[217px] leading-[119%] lg:text-[32px] text-[23px] font-normal font-balsamiq">
                    {" "}
                    95% Uniswa{" "}
                  </p>
                  <p className="text-[#23AAAC] max-w-[217px] text-right leading-[119%] lg:text-[32px] text-[23px] font-normal font-balsamiq">
                    {" "}
                    5% Marketing{" "}
                  </p>
                  <p className="text-white max-w-[217px] text-right leading-[119%] lg:text-[32px] text-[23px]  font-normal font-balsamiq">
                    {" "}
                    Allocation
                  </p>
                </div>
              ...
              >
                ...
                <p className="text-[#FB5352] leading-[119%] lg:text-[32px] text-[23px] font-normal font-balsamiq">
                  {" "}
                  No Mint Function{" "}
                </p>
              </div>
            ...
            >
              <div className=" flex flex-col sm:gap-[35px] gap-[20px]">
                <div className="flex sm:gap-[32px] gap-[20px]">
                  ...
                  <div className="flex flex-col gap-[5px]">
                    <p className="text-[#FBA11D] leading-[119%] sm:text-[32px] text-[25px] font-normal font-balsamiq">
                      {" "}
                      333,333,333{" "}
                    </p>
                    <p className="text-white leading-[138%] font-normal text-[24px] font-balsamiq">
                      {" "}
                      Supply{" "}
                    </p>
                  </div>
                ...
                <div className="flex sm:gap-[32px] gap-[20px]">
                  ...
                  <div className="flex flex-col gap-[5px]">
                    <div className="flex flex-row flex-wrap gap-[5px]">
                      <p className="text-[#23AAAC] leading-[119%] sm:text-[32px] text-[25px] font-normal font-balsamiq">
                        {" "}
                        95% Uniswa{" "}
                      </p>
                      <p className="text-[#23AAAC] leading-[119%] sm:text-[32px] text-[25px] font-normal font-balsamiq">
                    ...
                    <p className="text-white leading-[138%] sm:text-[32px] text-[25px] font-normal font-balsamiq">
                      {" "}
                      Allocation
                    </p>
                  </div>
                ...
                <div className="flex sm:gap-[32px] gap-[20px]">
                  ...
                  <div className="flex flex-col gap-[5px]">
                    <p className="text-[#D45B07] leading-[119%] sm:text-[32px] text-[25px] font-normal font-balsamiq">
                      No Tax{" "}
                    </p>
                  </div>
                </div>
                <div className="flex sm:gap-[32px] gap-[20px]">
                  ...
                  <div className="flex flex-col gap-[5px]">
                    <p className="text-[#FB5352] leading-[119%] sm:text-[32px] text-[25px] font-normal font-balsamiq">
                      No Mint Function{" "}
                    </p>
                  </div>
                </div>
                <div className="flex sm:gap-[32px] gap-[20px]">
                  ...
                  <div className="flex flex-col gap-[5px]">
                    <p className="text-[#8EC627] leading-[119%] sm:text-[32px] text-[25px] font-normal font-balsamiq">
                      Liquidity lock for 1 year
                    </p>
                  </div>
                </div>
        ...
        <img
          src={TokenDino}
          alt="TokenDino"
          className="xl:max-w-[280px] lg:max-w-[200px] sm:max-w-[150px] max-w-[100px] w-full absolute bottom-0 left-0"
        />
      </div>
    </div>
  );
